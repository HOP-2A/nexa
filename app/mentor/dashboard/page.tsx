                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">
                      Expert <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">Console</span>
                    </h1>
                    <p className="text-slate-500 font-medium mt-1">Empowering the next generation of talent.</p>
                  </div>
                  ...
                  <div className="col-span-12 lg:col-span-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        <h3 className="text-xl font-bold text-slate-800">Student Reservations</h3>
                        <p className="text-slate-500 text-sm mt-2">Manage your upcoming bookings and student meetings.</p>
                      </div>
                      ...
                      <div className="p-8 rounded-[32px] bg-white/60 backdrop-blur-xl border border-white/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                        ...
                        <h3 className="text-xl font-bold text-slate-800">Course Analytics</h3>
                        <p className="text-slate-500 text-sm mt-2">Track performance and engagement across your content.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative overflow-hidden rounded-[40px] p-10 bg-slate-900 text-white shadow-2xl">
                      <div className="relative z-10">
                        <span className="px-4 py-1.5 bg-indigo-500/20 text-indigo-300 text-xs font-bold rounded-full border border-indigo-500/30 uppercase tracking-widest">Growth Tip</span>
                        <h2 className="text-3xl font-bold mt-6 mb-4">Host a Live Workshop</h2>
                        <p className="text-slate-400 max-w-md leading-relaxed mb-8">Increase your student engagement by 40% by hosting a live Q&A session this week.</p>
                        <button className="px-6 py-3 bg-white text-slate-900 font-bold rounded-xl hover:bg-slate-100 transition-colors">Schedule Now</button>
                      </div>
                  ...
                  <div className="col-span-12 lg:col-span-4 space-y-6">
                    <div className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-[32px] p-6 shadow-sm">
                      <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center justify-between">
                        Active Courses
                        <span className="text-xs bg-slate-200 text-slate-600 px-2.5 py-1 rounded-lg font-bold">{courses.length}</span>
                      </h3>
                        ...
                        {courses.map((course, index) => (
                          ...
                          >
                            ...
                            <div className="flex-1 text-left">
                              <p className="font-bold text-slate-700 group-hover:text-indigo-600 transition-colors truncate">{course.courseTitle}</p>
                              <p className="text-xs text-slate-400">Manage dates & curriculum</p>
                            </div>
                          </button>
                        ))}
                      </div>
